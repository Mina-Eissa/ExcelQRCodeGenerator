...
{
    public partial class qrCodeGeneratorPage : Form
    {
        ...
        private void qrCodeGeneratorPage_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (application != null)
            {
                if (workbook != null)
        ...
        private void qrCodeGeneratorPage_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (application != null)
            {
                application.Quit();
